![docker image](https://github.com/nomad-hzb/solai-image/actions/workflows/docker-publish.yml/badge.svg)
...
```sh
curl -L -o nomad-oasis.zip "https://github.com/nomad-hzb/solai-image/raw/main/nomad-oasis.zip"
```
...
your `docker-compose.yaml` with `ghcr.io/nomad-hzb/solai-image:main` for the services
 ...
 *I get an* `Error response from daemon: Head "https://ghcr.io/v2/nomad-hzb/solai-image/manifests/main": unauthorized`
